            ...
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                ...
                <SwiperSlide>
                    <div className="flex flex-col gap-4 lg:gap-0 lg:flex-row p-6 shadow-xl items-center justify-center" data-aos="flip-left">
                        ...
                        <div className='max-w-xs flex flex-col gap-2'>
                            ...
                            <a rel='noreferrer' href="https://lucky-pear.surge.sh/" target='_blank' className='btn bg-orange-600 text-white hover:text-black mt-3'>
                ...
                <SwiperSlide>
                    <div className="flex flex-col gap-4 lg:gap-0 lg:flex-row p-6 shadow-xl items-center justify-center" data-aos="flip-right">
                        <InfiniteScroll dataLength={8} height={300}>
                            <a rel='noreferrer' href="https://noxious-apples.surge.sh/" target='_blank'>
                ...
                <SwiperSlide>
                    <div className="flex flex-col gap-4 lg:gap-0 lg:flex-row p-6 shadow-xl items-center justify-center" data-aos="flip-left">
                        <InfiniteScroll dataLength={8} height={300}>
                            <a rel='noreferrer' href="https://erratic-houses.surge.sh/" target='_blank'>
                        ...
                        <div className='max-w-xs flex flex-col gap-2'>
                            ...
                            <p className='font-bold text-red-800'>Contains with Admin panel </p>
                            <a rel='noreferrer' href="https://erratic-houses.surge.sh/" target='_blank' className='btn bg-orange-600 text-white hover:text-black mt-3'>
                                Live Link <FaExternalLinkAlt />
                            </a>
                        </div>
                    </div>
                ...
                <SwiperSlide>
                    <div className="flex flex-col gap-4 lg:gap-0 lg:flex-row p-6 shadow-xl items-center justify-center" data-aos="flip-right">
                        <InfiniteScroll dataLength={8} height={300}>
                            <a rel='noreferrer' href="https://square-hall.surge.sh/" target='_blank'>
                        ...
                        <div className='max-w-xs flex flex-col gap-2'>
                            ...
                            <a rel='noreferrer' href="https://square-hall.surge.sh/" target='_blank' className='btn bg-orange-600 text-white hover:text-black mt-3'>
                                Live Link <FaExternalLinkAlt />
                            </a>
                        </div>
                    </div>
