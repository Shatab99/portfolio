                ...
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='lg:w-[650px]'>
                        ...
                        <div className='flex items-center gap-4'>
                            ...
                            <a rel='noreferrer' href='https://drive.google.com/file/d/1Li2lpzNfh92CJ1mAvaWwlfuHgZA96cvC/view?usp=sharing' target='_blank' className='btn btn-outline text-orange-600 hover:bg-orange-600 hover:border-orange-600  transition-all duration-1000'>
